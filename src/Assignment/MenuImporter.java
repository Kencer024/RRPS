...
public class MenuImporter {
	public static MenuList	 importExcel(MenuList menu) {
		...
		tmp_item = new Item();
		tmp_item.setId(menu.getNewFoodId("Beef"));
		...
		tmp_item = new Item();
		tmp_item.setId(menu.getNewFoodId("Fish"));
		...
		tmp_item = new Item();
		tmp_item.setId(menu.getNewFoodId("Salads & Wraps"));
		...
		tmp_item = new Item();
		tmp_item.setId(menu.getNewFoodId("Chicken"));
		...
		tmp_item = new Item();
		tmp_item.setId(menu.getNewFoodId("Drinks"));
		...
		tmp_item = new Item();
		tmp_item.setId(menu.getNewFoodId("Sides"));
